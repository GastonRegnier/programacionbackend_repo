...
const prueba = async () => {
    console.log(await db.saveProducto({
        name: "Samsung s20", price: "75200", thumbnail: "https://via.placeholder.com/200", id: 4,
        name: "Xiaomi s20", price: "95200", thumbnail: "https://via.placeholder.com/200", id: 8,
        name: "Apple", price: "85200", thumbnail: "https://via.placeholder.com/200", id: 7
    }))
